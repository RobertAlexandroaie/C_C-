...
void Contact::setAtribut(char *linie)
{}
...
void Colleague::setAtribut(const char *categorie)
{
...
void Friend::setAtribut(const char *data)
{
...
void Acquaintance::setAtribut(const char *profesie)
{
