...
[System.ServiceModel.ServiceContractAttribute(ConfigurationName="Database")]
public interface Database
{
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Database/GetCustomerById", ReplyAction="http://tempuri.org/Database/GetCustomerByIdResponse")]
    DatabaseTablesClasses.Customer GetCustomerById(int _id);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Database/InsertCustomer", ReplyAction="http://tempuri.org/Database/InsertCustomerResponse")]
    void InsertCustomer(string _name, string _address);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Database/UpdateCustomer", ReplyAction="http://tempuri.org/Database/UpdateCustomerResponse")]
    void UpdateCustomer(DatabaseTablesClasses.Customer customer);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Database/DeleteCustomer", ReplyAction="http://tempuri.org/Database/DeleteCustomerResponse")]
    void DeleteCustomer(DatabaseTablesClasses.Customer customer);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Database/GetOrder", ReplyAction="http://tempuri.org/Database/GetOrderResponse")]
    DatabaseTablesClasses.Order GetOrder(int _orderid);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Database/InsertOrder", ReplyAction="http://tempuri.org/Database/InsertOrderResponse")]
    void InsertOrder(int _customerid, System.DateTime dt, decimal _value);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Database/UpdateOrder", ReplyAction="http://tempuri.org/Database/UpdateOrderResponse")]
    void UpdateOrder(DatabaseTablesClasses.Order order);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Database/DeleteOrder", ReplyAction="http://tempuri.org/Database/DeleteOrderResponse")]
    void DeleteOrder(DatabaseTablesClasses.Order order);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Database/GetAllCustomer", ReplyAction="http://tempuri.org/Database/GetAllCustomerResponse")]
    DatabaseTablesClasses.Customer[] GetAllCustomer();
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Database/GetAllOrdersForCustomer", ReplyAction="http://tempuri.org/Database/GetAllOrdersForCustomerResponse")]
    DatabaseTablesClasses.Order[] GetAllOrdersForCustomer(int _customerid);
}

[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
public interface DatabaseChannel : Database, System.ServiceModel.IClientChannel
{
}

[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
public partial class DatabaseClient : System.ServiceModel.ClientBase<Database>, Database
{
