...
namespace T1
{
    public partial class Form1 : Form
    {
        ...
        public Form1(DbConnection myConnection)
        {
            this._connection = myConnection;
            this._context = this._connection.Context;
        ...
        private void Form1_Load(object sender, System.EventArgs e)
        {
            ...
            this.listBox1.DataSource = this._context.GetCustomers();
        ...
        private void edit_customer_Click(object sender, System.EventArgs e)
        {
            ...
            var customer = this._context.GetCustomer(short.Parse(this.listBox1.SelectedValue.ToString()));
        ...
        private void save_customer_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                this._context.EditCustomer(data);
        ...
        private void add_customer_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                this._context.SaveCustomer(data);
        ...
        private void view_order_Click(object sender, System.EventArgs e)
        {
            ...
            var od = this._context.GetOrderDetails(((ORDER)order).ORDERID);
        ...
        private void add_order_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                this._context.SaveOrder(data);

                this.resetLayout();
                this.dataGridView1.DataSource = this._context.GetOrders(short.Parse(this.listBox1.SelectedValue.ToString()));
        ...
        private void delete_customer_Click(object sender, System.EventArgs e)
        {
            if (MessageBox.Show("Are you sure you want to delete the selected item?", "Customer", MessageBoxButtons.YesNo, MessageBoxIcon.Question).Equals(DialogResult.Yes))
            {
                try
                {
                    this._context.DeleteCustomer(short.Parse(this.listBox1.SelectedValue.ToString()));
